...
MCAP_STATE_TOPICS = [
    f"/mmk/observation/{comp}/joint_state/position" for comp in components
]
MCAP_ACTION_TOPICS = [f"/mmk/action/{comp}/joint_state/position" for comp in components]
MCAP_CAMERA_NAMES = [f"/mmk/{cam}/color/image_raw" for cam in cameras]
